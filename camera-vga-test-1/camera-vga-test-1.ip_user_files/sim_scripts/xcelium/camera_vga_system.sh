...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../tools/Xilinx2025/2025.1/data/rsb/busdef" +incdir+"../../../camera-vga-test-1.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../tools/Xilinx2025/2025.1/data/rsb/busdef" +incdir+"../../../camera-vga-test-1.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.camera_vga_system xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.camera_vga_system -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log camera_vga_system_sc.so .tmp_log xcelium_lib waves.shm c.obj)
