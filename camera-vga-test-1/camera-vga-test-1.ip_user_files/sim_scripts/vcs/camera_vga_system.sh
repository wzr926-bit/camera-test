...
#
# Script generated by Vivado on Fri Mar 20 15:24:07 CST 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : camera_vga_system.sh
...
#
# Usage        : camera_vga_system.sh
#                camera_vga_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                camera_vga_system.sh [-reset_run]
#                camera_vga_system.sh [-reset_log]
#                camera_vga_system.sh [-help]
#
...
#                script (type 'camera_vga_system.sh -help' for more information).
#
...
# script info
echo -e "camera_vga_system.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./camera_vga_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../tools/Xilinx2025/2025.1/data/rsb/busdef" +incdir+"../../../camera-vga-test-1.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../tools/Xilinx2025/2025.1/data/rsb/busdef" +incdir+"../../../camera-vga-test-1.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.camera_vga_system xil_defaultlib.glbl -o camera_vga_system_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./camera_vga_system_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/tsmc/6a3f28f3-1a75-4d55-baf2-a6aa8be84a59/kwc/vivado"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key camera_vga_system_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc camera_vga_system_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./camera_vga_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: camera_vga_system.sh [-help]\n\
Usage: camera_vga_system.sh [-step]\n\
Usage: camera_vga_system.sh [-lib_map_path]\n\
Usage: camera_vga_system.sh [-reset_run]\n\
Usage: camera_vga_system.sh [-reset_log]\n\
Usage: camera_vga_system.sh [-keep_index]\n\
Usage: camera_vga_system.sh [-noclean_files]\n\n\
