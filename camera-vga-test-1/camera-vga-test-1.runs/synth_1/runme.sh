...
HD_PWD='/media/tsmc/6a3f28f3-1a75-4d55-baf2-a6aa8be84a59/kwc/vivado project/camera-vga-test-1/camera-vga-test-1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_vga_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_vga_system.tcl
