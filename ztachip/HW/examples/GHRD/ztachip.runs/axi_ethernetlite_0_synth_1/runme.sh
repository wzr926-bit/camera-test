...
HD_PWD='/media/tsmc/6a3f28f3-1a75-4d55-baf2-a6aa8be84a59/kwc/100t/ztachip/HW/examples/GHRD/ztachip.runs/axi_ethernetlite_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ethernetlite_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_ethernetlite_0.tcl
