...
HD_PWD='/media/tsmc/6a3f28f3-1a75-4d55-baf2-a6aa8be84a59/kwc/100t/ztachip/HW/examples/GHRD/ztachip.runs/float_mul_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_mul.tcl
